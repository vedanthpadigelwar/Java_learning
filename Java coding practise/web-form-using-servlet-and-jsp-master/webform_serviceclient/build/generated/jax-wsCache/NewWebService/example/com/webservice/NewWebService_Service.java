 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://webservice.com.example/", wsdlLocation = "http://localhost:8082/WebApplication1/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://webservice.com.example/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/WebApplication1/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://webservice.com.example/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.com.example/", "NewWebServicePort"), NewWebService.class, features);
    }
